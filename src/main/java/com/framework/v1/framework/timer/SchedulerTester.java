...
public class SchedulerTester {
    ...
    public void testCronTrigger() throws InterruptedException {
        ...
        String cron = "*/2 * * * * ?";
        SchedulerUtil.getScheduler().hadleCronTrigger(jobId,jobName,jobGroupName,triggerName,triggerGroupName,jobClass,cron);
        Thread.sleep(300000);
    ...
    public void testInvokeTrigger() throws InterruptedException {
        ...
        Class jobClass  = SchedulerTestJob.class;
        String cron = "*/2 * * * * ?";
        SchedulerUtil.getScheduler().hadleInvokeTrigger(jobId,jobName,jobGroupName,triggerName,triggerGroupName,jobClass,cron,3);
        Thread.sleep(  10000);
    ...
    public void testCronTriggers() throws InterruptedException {
        ...
        SchedulerUtil.getScheduler().hadleCronTriggers(jobId,jobName,jobGroupName,triggerNames,triggerGroupNames,jobClass,cron);
        Thread.sleep(300000);
    ...
    public void testTimerTrigger() throws InterruptedException {
        ...
        int time = 1;
        int count = 5;
        SchedulerUtil.getScheduler().handleSimpleTrigger(jobId,jobName,jobGroupName,triggerName,triggerGroupName,jobClass,time,count);
        //Thread.sleep(20000);
